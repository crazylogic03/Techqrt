...
const Analytics = ({ searchQuery }) => {
  const trendingAds = [
    { title: 'Game Online Vouchers 20% OFF', publishedDays: 91, visitors: '672k' },
    { title: '10% OFF Granola Store', publishedDays: 91, visitors: '672k' },
    { title: '50% OFF Floor Lamp Get it Now!', publishedDays: 91, visitors: '672k' }
  ];

  const performedCampaigns = [
    { id: '#AD000245', title: '50% OFF Floor Lamp Get it Now!', conversion: '$63.04', engagement: '5,412k' },
    { id: '#AD000245', title: 'Property New Year Sales!', conversion: '$63.04', engagement: '5,412k' },
    { id: '#AD000245', title: 'Gaya Fashion Store Grand Opening', conversion: '$63.04', engagement: '5,412k' }
  ];

  const filteredTrendingAds = useMemo(() => {
    if (!searchQuery) return trendingAds;
    return trendingAds.filter(ad => 
      ad.title.toLowerCase().includes(searchQuery.toLowerCase())
    );
  }, [searchQuery]);

  const filteredPerformedCampaigns = useMemo(() => {
    if (!searchQuery) return performedCampaigns;
    return performedCampaigns.filter(campaign => 
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-4 sm:space-y-0">
        <h2 className="text-xl lg:text-2xl font-bold text-gray-900">Analytics</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
        ...
        <div className="bg-white p-4 lg:p-6 rounded-lg shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-base lg:text-lg font-semibold text-gray-900">Trending Ads</h3>
            ...
            {filteredTrendingAds.map((ad, index) => (
              <div key={index} className="flex flex-col sm:flex-row sm:items-center justify-between space-y-2 sm:space-y-0">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500">Published {ad.publishedDays} days ago</p>
                </div>
                <div className="text-right">
                  <div className="w-8 lg:w-12 h-4 lg:h-6 mb-1">
                  ...
                  <p className="text-sm font-semibold text-gray-900">{ad.visitors}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
        ...
        <div className="bg-white p-4 lg:p-6 rounded-lg shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-base lg:text-lg font-semibold text-gray-900">Ads Engagement</h3>
            <MoreHorizontal className="w-5 h-5 text-gray-400" />
          </div>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={index} className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-gray-900 text-sm">{item.platform}</p>
        ...
        <div className="bg-white p-4 lg:p-6 rounded-lg shadow-sm">
          <h3 className="text-base lg:text-lg font-semibold text-gray-900 mb-4">Most Performed Campaign</h3>
          <div className="space-y-4">
            {filteredPerformedCampaigns.map((campaign, index) => (
              <div key={index} className="border-b border-gray-100 pb-3 last:border-b-0">
                ...
                <p className="font-medium text-gray-900 mb-2 text-sm">{campaign.title}</p>
      ...
      {/* Insight Section */}
      <div className="bg-white p-4 lg:p-6 rounded-lg shadow-sm">
        <h3 className="text-base lg:text-lg font-semibold text-gray-900 mb-4">Insight</h3>
        <p className="text-sm text-gray-600 mb-4">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
        </p>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
          <div className="text-center">
            <p className="text-xl lg:text-2xl font-bold text-gray-900">83,876</p>
            <p className="text-sm text-gray-500">Total Campaign</p>
          </div>
          <div className="text-center">
            <p className="text-xl lg:text-2xl font-bold text-gray-900">$97,125</p>
            <p className="text-sm text-gray-500">Spend</p>
          </div>
          <div className="text-center">
            <p className="text-xl lg:text-2xl font-bold text-gray-900">$872,338</p>
            <p className="text-sm text-gray-500">Revenue</p>
          </div>
          <div className="text-center">
            <p className="text-xl lg:text-2xl font-bold text-gray-900">21,224</p>
      ...
      {/* Target Statistics */}
      <div className="bg-white p-4 lg:p-6 rounded-lg shadow-sm">
        <h3 className="text-base lg:text-lg font-semibold text-gray-900 mb-4">Target Statistics</h3>
        ...
        <div className="flex items-center justify-center">
          <div className="relative w-32 h-32 lg:w-48 lg:h-48">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <div className="w-8 h-8 lg:w-12 lg:h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-2">
                  <span className="text-purple-600 font-bold text-sm lg:text-base">Vi</span>
                </div>
              </div>
            </div>
          </div>
